...
| Attribute Name       | Required     | Type                  | Description                                                                                                                                                                                                                                                                                                                               |
|----------------------|--------------|-----------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **amount**           | optional     | [integer](#integer)   | If there are assigned coupons in the request, this attribute cannot be smaller than their amount, otherwise it is omitted. If this amount is higher than the number of assigned coupons, the rest of the coupons up to the this amount will be generated as unassigned coupons.                                                                                                                                                                    |
