...
| Element Name        | Required     | Type                | Description                   |
|---------------------|--------------|---------------------|-------------------------------|
| **quantity**        | **required** | [decimal](#decimal) | Quantity of goods sold.       |
| **price**           | **required** | [decimal](#decimal) | Price per unit including tax. |
| **priceWithoutTax** | optional     | [decimal](#decimal) | Price per unit without tax.   |
...
To link the order with a customer, there must be either **contactId** or **contact** specified. Only one of the elements is allowed!
