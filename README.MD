...
| Attribute Name | Required     | Type              | Description                                                                                           |
|----------------|--------------|-------------------|-------------------------------------------------------------------------------------------------------|
| **contactId**  | **required** | [string](#string) | Coupon recipient. An Id of the contact in the e-shop, must math **id** attribute in the contact feed. |
